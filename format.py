...
if args.zip:
	toDownload = ['data/GENRE/hg19/db/hg19_DNaseSeq/hg19BGpool_multLen150x150.bed.gz', 'data/GENRE/hg19/db/hg19_DNaseSeq/hg19BGpool_multLen150x150.db.gz','data/GENRE/hg19/genome/hg19_UnmaskedALL_UCSC.fa.gz']
	for f in toDownload:
